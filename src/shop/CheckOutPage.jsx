...
function CheckOutPage() {
  ...
  const [activeTab, setActiveTag] = useState("Visa");
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="tabs mt-3">
                ...
                {/* payment disclaimer */}
                <p className="mt-3 px-4 p-Disclaiemer"><em>Payment disclaimer:</em> By making this payment, you agree to our terms and conditions.</p>
              </div>
            </div>
          </div>
        </div>
